...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('7672489900.png', self.rect.right, self.rect.centery, 15, 20, 15)
        bullets.add(bullet)
...
w1 = GameSprite('2-f13052f5e4b517c0f038c79a07a4de25.jpeg',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('2-f13052f5e4b517c0f038c79a07a4de25.jpeg', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('png-transparent-chibi-knight-animation-concept-art-knight-game-cartoon-fictional-character.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('1505465.png', win_width - 85, win_height - 100, 80, 80)


monster1 = Enemy('crab.png', win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('crab.png', win_width - 80, 230, 80, 80, 5)
